Bitcoinafrica Core version *0.15.1* is now available from:

  <https://download.bitcoinafrica.org/bitcoinafrica-0.15.1/>
...
A number of changes to the way Bitcoinafrica Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 aBits per kB (0.00001 BTCA). This is to prepare for dropping the minimum transaction fee to 0.1 aBits per kB (0.0001 BTCA) in the next release.
