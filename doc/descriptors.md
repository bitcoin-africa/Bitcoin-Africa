# Support for Output Descriptors in Bitcoinafrica Core

Since Bitcoinafrica Core v0.17, there is support for Output Descriptors. This is a
...
on Bitcoinafrica's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bitcoinafrica Core wallets, a convenience function `combo` is
