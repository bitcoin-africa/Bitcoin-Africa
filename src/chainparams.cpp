...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.bitcoinafrica.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.bitcoinafricatools.com");
        vSeeds.emplace_back("dnsseed.bitcoinafricapool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("50cf739b3abac9abc5a8b8202b277a5c6b073bc1302e399d58ccb122182861de"); //1174621
        ...
        vSeeds.emplace_back("testnet-seed.bitcoinafricatools.com");
        vSeeds.emplace_back("seed-b.bitcoinafrica.loshan.co.uk");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x06, 0x40, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x40, 0x83, 0x94};
        ...
        checkpointData = {
            {
                {0, uint256S("48319340f0a5597c758046475dd81bd391779aa239028d41973a1c5696211f13")},
            }
        };
