...
//    QString copyrightText   = QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", 2011, COPYRIGHT_YEAR)).c_str());
    ...
    QSize splashSize(1352*devicePixelRatio,490*devicePixelRatio);
...
//    pixPaint.fillRect(rGradient, gradient);
    ...
    QRect rectIcon(QPoint(0,0), QSize(1386,502));

    const QSize requiredSize(1386,502);
